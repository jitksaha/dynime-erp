...
class DefultSetting extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_settings = [
            ...
            'favicon' => 'favicon.png',
            'titleText' => !empty(env('APP_NAME')) ? env('APP_NAME') : 'Dynime ERP',
            'footerText' => 'Copyright © ' . (!empty(env('APP_NAME')) ? env('APP_NAME') : 'Dynime ERP'),
            ...
            // SEO Settings
            'metaKeywords' => 'dynime, erp, dashboard, admin, panel, management',
            'metaTitle' => !empty(env('APP_NAME')) ? env('APP_NAME') . ' - Dashboard' : 'Dynime ERP - Dashboard',
            ...
            'contactUsUrl' => 'https://dynime.com/contact',
