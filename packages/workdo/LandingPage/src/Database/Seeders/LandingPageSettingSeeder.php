...
class LandingPageSettingSeeder extends Seeder
{
    ...
    {
        return [
            'company_name' => 'Dynime ERP',
            'contact_email' => 'support@dynime.com',
    ...
    private function getDefaultSections(): array
    {
        return [
            'hero' => [
                ...
                'subtitle' => 'Streamline your entire business lifecycle, from finance to operations, with Dynime ERP. One platform, infinite possibilities.',
                'primary_button_text' => 'Start Free Trial',
                'primary_button_link' => route('register'),
                'secondary_button_text' => 'Login',
                'secondary_button_link' => route('login'),
                'highlight_text' => 'Dynime ERP',
            ...
            'cta' => [
                ...
                'subtitle' => 'Join thousands of businesses already using Dynime ERP to streamline their operations.',
