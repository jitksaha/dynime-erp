...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Lead'])->group(function () {
    ...
    Route::get('crm/leads/{lead}/notes', [LeadController::class, 'getNotes'])->name('lead.leads.get-notes');
    Route::post('crm/leads/{lead}/notes', [LeadController::class, 'storeNote'])->name('lead.leads.store-note');
    Route::delete('crm/leads/{lead}/notes/{note}', [LeadController::class, 'destroyNote'])->name('lead.leads.destroy-note');
