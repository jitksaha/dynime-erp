            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '0.5rem' }}>
                    <TooltipProvider delayDuration={100}>
                        {/* High-Contrast Segmented Shift Mode Switcher Toggle */}
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} className="bg-slate-200/90 p-1 rounded-xl gap-1 border border-slate-300/80 shadow-inner">
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    ...
                                    >
                                        <Building2 className={`w-3.5 h-3.5 ${currentShiftType === 'fixed' ? 'text-white' : 'text-slate-600'}`} />
                                        <span>{t('Fixed')}</span>
                                    </button>
                                </TooltipTrigger>
                                <TooltipContent side="bottom" className="text-xs font-bold p-1.5">
                                    {t('Fixed Office Shift (Standard Hours)')}
                                </TooltipContent>
                            </Tooltip>
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <button
                                        ...
                                        className={`px-2.5 py-1 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer relative ${
                                            currentShiftType === 'flexible'
                                                ? 'bg-amber-600 text-white shadow-sm font-extrabold'
                                                : 'text-slate-600 hover:text-slate-900 hover:bg-slate-300/50'
                                        }`}
                                    >
                                        <SlidersHorizontal className={`w-3.5 h-3.5 ${currentShiftType === 'flexible' ? 'text-white' : 'text-slate-600'}`} />
                                ...
                                <TooltipContent side="bottom" className="text-xs font-bold p-1.5">
                                    {t('Flexible Shift Mode (Remote & Off-site)')}
                                </TooltipContent>
                            </Tooltip>
                        </div>
