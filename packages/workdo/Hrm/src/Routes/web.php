...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Hrm'])->group(function () {
    ...
    Route::prefix('hrm/document-builder')->name('hrm.document-builder.')->group(function () {
        Route::get('/', [DocumentBuilderController::class, 'index'])->name('index');
...
Route::middleware(['web'])->group(function () {
    Route::get('/employee/verify', [EmployeeController::class, 'verifyIndex'])->name('hrm.employee.verify.index');
    Route::post('/employee/verify', [EmployeeController::class, 'verifySearch'])->name('hrm.employee.verify.search');
    Route::get('/employee/verify/{employeeId}', [EmployeeController::class, 'verifyShow'])->name('hrm.employee.verify.show');
});
