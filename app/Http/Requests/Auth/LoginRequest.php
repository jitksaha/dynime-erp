...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'email.required' => __('Email address or Phone number is required.'),
            'email.string' => __('Login identifier must be a valid string.'),
    ...
    public function authenticate(): void
    {
        ...
        $fieldType = filter_var($loginValue, FILTER_VALIDATE_EMAIL) ? 'email' : 'mobile_no';
