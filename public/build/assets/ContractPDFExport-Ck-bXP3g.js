const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-DSTO_hnx.js","./vendor-Bq2s2JnP.js","./jspdf.es.min-CWhQN5iC.js","./app-B6jh9pZB.js","./ui-DWAV2h0C.js","./app-CQG9E_-B.css","./app-CUpZHHUF.css","./html2canvas-BF968m9e.js"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-B6jh9pZB.js";import{j as i}from"./ui-DWAV2h0C.js";import{B as x}from"./button-D3GyKW9X.js";import{a as f,b,c as h}from"./tooltip-DWmI0Bur.js";import{f as v,a as n,k as p}from"./helpers-DOZydX8G.js";import{u as _}from"./useTranslation-BPbLQHYP.js";import{D as y}from"./download-DLX5uzo4.js";/* empty css            */import"./vendor-Bq2s2JnP.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-DrcJ8Itn.js";import"./index-DX5gQBRh.js";import"./createLucideIcon-Ca1kx9kz.js";function A({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-DSTO_hnx.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4,5,6,7]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{A as default};
