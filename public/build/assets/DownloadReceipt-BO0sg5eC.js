import{a as v}from"./html2pdf-LaG8qCdM.js";import{a as f,f as n}from"./helpers-jsSuC4rL.js";import"./vendor-Bq2s2JnP.js";import"./jspdf.es.min-C-B6yYZY.js";import"./app-BOZZgXdx.js";import"./ui-DWAV2h0C.js";/* empty css            */import"./html2canvas-BF968m9e.js";const A=async(s,a)=>{var r;const m=`
        <div class="receipt">
            <div class="header">
    ...
    `,t=document.createElement("div");t.innerHTML=m,document.body.appendChild(t);const c={margin:.1,filename:`receipt-${s.pos_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"mm",format:[80,297],orientation:"portrait"}};try{await v().set(c).from(t).save()}catch(i){console.error("PDF generation failed:",i)}finally{document.body.removeChild(t)}};export{A as downloadReceiptPDF};
