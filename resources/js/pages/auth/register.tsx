    ...
    return (
        ...
        >
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                {/* 3. Single-Page Section-Wise Onboarding Form for Staff / HR */}
                {isStaffOrHr ? (
                    <div className="space-y-6 pt-2">
                        ...
                        {/* SECTION 2: Employment & Position (Dynamic Dropdowns) */}
                        <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 space-y-3">
                            <div className="flex items-center gap-2 pb-2 border-b border-slate-200 dark:border-slate-800">
                        ...
                        {/* SECTION 4: Financial & Payroll Details */}
                        <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 space-y-3">
                            <div className="flex items-center gap-2 pb-2 border-b border-slate-200 dark:border-slate-800">
                                <CreditCard className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200">
                                    {t('Payroll & Financial Information')}
                                </h3>
                            </div>
                        ...
                        {/* SECTION 5: Password Credentials & Schedule */}
                        <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 space-y-3">
                            <div className="flex items-center gap-2 pb-2 border-b border-slate-200 dark:border-slate-800">
                                <Clock className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200">
                                    {t('Account Security & Schedule')}
                                </h3>
                            </div>
                        ...
                        >
                            {processing ? t('Submitting Onboarding Profile...') : t('Submit Complete Onboarding Profile')}
                        </Button>
                    </div>
                ) : (
