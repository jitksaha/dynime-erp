...
export default function Login({
    ...
    return (
        <AuthLayout
            ...
            description={t('Enter your email/phone number and password below to log in')}
        >
            <Head title={t('Log in')} />
            ...
            <form onSubmit={submit} className="space-y-4">
                <div className="space-y-4">
                    <div className="space-y-2">
                        <Label htmlFor="email" className="text-sm font-medium text-gray-900 dark:text-white">{t('Email address or Phone number')}</Label>
                        <Input
                            id="email"
                            type="text"
                            name="email"
